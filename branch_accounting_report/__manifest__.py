
{
    ...
    "version" : "16.0.0.4",
    "category" : "Accounting",
    'summary': 'Multiple Branch Management Multi Branch report branch Invoicing branch financial branch wise accounting reports branch reports branch Accounting statement Financial branch Reports Multi Branch accounting report branch financial reports branch filter report',
    "description": """
